...
using Argengrill.Core.Infrastructure.DependencyManagement;
using Argengrill.Core.Plugins;
using Argengrill.Core.Packaging;
using Argengrill.Core.Utilities;
using Argengrill.Core.Utilities.Threading;
using Argengrill.Core.Packaging.Updater;
...
namespace Argengrill.Core.Plugins
{
    /// <summary>
